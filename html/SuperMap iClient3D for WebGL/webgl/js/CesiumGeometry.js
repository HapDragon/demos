(function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === 'object' && typeof module === 'object')
        ...
        exports["SuperMap3DGeometry"] = factory(require("SuperMap3D"));
    else
        root["SuperMap3DGeometry"] = factory(root["SuperMap3D"]);
    ...
    ([
        ...
        (function (module, exports, __webpack_require__) {
             ...
             */
            (function () {
                var SuperMap3DScriptRegex = /((?:.*\/)|^)SuperMap3DGeometry[\w-]*\.js(?:\W|$)/i;

                function getBaseUrlFromSuperMap3DScript() {
                    var scripts = document.getElementsByTagName('script');
                    for (var i = 0, len = scripts.length; i < len; ++i) {
                        var src = scripts[i].getAttribute('src');
                        var result = SuperMap3DScriptRegex.exec(src);
                        if (result !== null) {
                            return result[1];
                        }
                    }
                ...
                util.getBaseUrl = function () {
                    if (baseUrl === undefined) {
                        baseUrl = getBaseUrlFromSuperMap3DScript();
                    }
                    return baseUrl;
                };
            })();
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var _SuperMap3D = __webpack_require__(0);

            var _SuperMap3D2 = _interopRequireDefault(_SuperMap3D);
            ...
            _SuperMap3D2.default = _SuperMap3D2;
            var BoundingSphere = _SuperMap3D2.default.BoundingSphere;
            var Cartesian3 = _SuperMap3D2.default.Cartesian3;
            var Color = _SuperMap3D2.default.Color;
            var combine = _SuperMap3D2.default.combine;
            var ComponentDatatype = _SuperMap3D2.default.ComponentDatatype;
            var defaultValue = _SuperMap3D2.default.defaultValue;
            var defined = _SuperMap3D2.default.defined;
            var defineProperties = _SuperMap3D2.default.defineProperties;
            var destroyObject = _SuperMap3D2.default.destroyObject;
            var DeveloperError = _SuperMap3D2.default.DeveloperError;
            var Matrix4 = _SuperMap3D2.default.Matrix4;
            var PrimitiveType = _SuperMap3D2.default.PrimitiveType;
            var Buffer = _SuperMap3D2.default.Buffer;
            var BufferUsage = _SuperMap3D2.default.BufferUsage;
            var DrawCommand = _SuperMap3D2.default.DrawCommand;
            var Pass = _SuperMap3D2.default.Pass;
            var RenderState = _SuperMap3D2.default.RenderState;
            var ShaderProgram = _SuperMap3D2.default.ShaderProgram;
            var ShaderSource = _SuperMap3D2.default.ShaderSource;
            var VertexArray = _SuperMap3D2.default.VertexArray;
            var BlendingState = _SuperMap3D2.default.BlendingState;
            var CullFace = _SuperMap3D2.default.CullFace;
            var Material = _SuperMap3D2.default.Material;
            var SceneMode = _SuperMap3D2.default.SceneMode;
            var VertexFormat = _SuperMap3D2.default.VertexFormat;
            var SuperMap3DMath = _SuperMap3D2.default.Math;
            var Matrix3 = _SuperMap3D2.default.Matrix3;
            var Matrix4 = _SuperMap3D2.default.Matrix4;
            var JulianDate = _SuperMap3D2.default.JulianDate;

            var BoxGeometry = _SuperMap3D2.default.BoxGeometry;
            var EllipsoidGeometry = _SuperMap3D2.default.EllipsoidGeometry;
            ...
            RectangularSensorPrimitive.prototype.update = function (frameState) {
                ...
                if (this.showScanPlane) {
                    ...
                    //增加判断，适配SuperMap3D1.54以后的，防止time与this._time一致并且没有变化
                    if (timeDiff == 0) {
                    ...
                    if (this.scanPlaneMode == 'horizontal') {
                        ...
                        _SuperMap3D2.default.Matrix3.fromRotationX(this._scanePlaneYHalfAngle, matrix3Scratch);
                    } else {
                        ...
                        _SuperMap3D2.default.Matrix3.fromRotationY(this._scanePlaneXHalfAngle, matrix3Scratch);
                    }

                    _SuperMap3D2.default.Matrix4.multiplyByMatrix3(this.modelMatrix, matrix3Scratch, this._computedScanPlaneModelMatrix);
            ...
            function computeSectorPositions(primitive, unitPosition) {
                ...
                positions.push(zoy.map(function (p) {
                    return Matrix3.multiplyByVector(matrix3, p, new _SuperMap3D2.default.Cartesian3());
                }));
            ...
            function createDomeVertexArray(context) {
                var geometry = _SuperMap3D2.default.EllipsoidGeometry.createGeometry(new _SuperMap3D2.default.EllipsoidGeometry({
            ...
            function createDomeLineVertexArray(context) {
                var geometry = _SuperMap3D2.default.EllipsoidOutlineGeometry.createGeometry(new _SuperMap3D2.default.EllipsoidOutlineGeometry({
                    vertexFormat: VertexFormat.POSITION_ONLY,
                    stackPartitions: 32,
                    slicePartitions: 32
                }));
            ...
            function createVertexArray(primitive, frameState) {
                ...
                if (primitive.showScanPlane) {
                    ...
                    if (primitive.scanPlaneMode == 'horizontal') {
                        var unitScanPlanePositions = computeUnitPosiiton(primitive, SuperMap3DMath.PI_OVER_TWO, 0);
                        primitive._scanPlaneVA = createScanPlaneVertexArray(context, unitScanPlanePositions.zox);
                    } else {
                        var unitScanPlanePositions = computeUnitPosiiton(primitive, 0, SuperMap3DMath.PI_OVER_TWO);
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var BoundingSphere = _SuperMap3D2.default.BoundingSphere,
                Cartesian3 = _SuperMap3D2.default.Cartesian3,
                Check = _SuperMap3D2.default.Check,
                ComponentDatatype = _SuperMap3D2.default.ComponentDatatype,
                defaultValue = _SuperMap3D2.default.defaultValue,
                defined = _SuperMap3D2.default.defined,
                Geometry = _SuperMap3D2.default.Geometry,
                GeometryAttribute = _SuperMap3D2.default.GeometryAttribute,
                GeometryAttributes = _SuperMap3D2.default.GeometryAttributes,
                PrimitiveType = _SuperMap3D2.default.PrimitiveType,
                VertexFormat = _SuperMap3D2.default.VertexFormat,
                SuperMap3DMath = _SuperMap3D2.default.Math,
                GeometryPipeline = _SuperMap3D2.default.GeometryPipeline,
                IndexDatatype = _SuperMap3D2.default.IndexDatatype,
                Ellipsoid = _SuperMap3D2.default.Ellipsoid;
            ...
            ConicArcSensorGeometry.createGeometry = function (conicSensorGeometry) {
                ...
                if (vertexFormat.position) {
                    ...
                    for (var i = 0; i < slicePartitions; i++) {
                        var theta = SuperMap3DMath.TWO_PI * i / (slicePartitions - 1);
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var BoundingSphere = _SuperMap3D2.default.BoundingSphere,
                ...
                defaultValue = _SuperMap3D2.default.defaultValue,
                defined = _SuperMap3D2.default.defined,
                DeveloperError = _SuperMap3D2.default.DeveloperError,
                Ellipsoid = _SuperMap3D2.default.Ellipsoid,
                Geometry = _SuperMap3D2.default.Geometry,
                GeometryAttribute = _SuperMap3D2.default.GeometryAttribute,
                GeometryAttributes = _SuperMap3D2.default.GeometryAttributes,
            ...
            ConicArcSensorOutlineGeometry.createGeometry = function (conicSensorGeometry) {
                ...
                for (i = 0; i < subdivisions; i++) {
                    theta = SuperMap3DMath.TWO_PI * i / subdivisions;
                    cosTheta[i] = cos(theta);
                    sinTheta[i] = sin(theta);
                }
                ...
                for (i = 0; i < slicePartitions; i++) {
                    theta = SuperMap3DMath.TWO_PI * i / slicePartitions;
                    cosTheta[i] = cos(theta);
                    sinTheta[i] = sin(theta);
                }
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var defaultValue = _SuperMap3D2.default.defaultValue,
                defined = _SuperMap3D2.default.defined,
                defineProperties = _SuperMap3D2.default.defineProperties,
                DeveloperError = _SuperMap3D2.default.DeveloperError,
                Event = _SuperMap3D2.default.Event,
                createMaterialPropertyDescriptor = _SuperMap3D2.default.createMaterialPropertyDescriptor,
                createPropertyDescriptor = _SuperMap3D2.default.createPropertyDescriptor;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            _SuperMap3D2.default.getLinkedPointList = _getLinkedPointList.getLinkedPointList;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            //conicSensor
            _SuperMap3D2.default.RectangularSensorPrimitive = _RectangularSensorPrimitive.RectangularSensorPrimitive;
            _SuperMap3D2.default.RectangularSensorGraphics = _RectangularSensorGraphics.RectangularSensorGraphics;
            _SuperMap3D2.default.RectangularSensorVisualizer = _RectangularSensorVisualizer.RectangularSensorVisualizer;

            //conicSensor
            _SuperMap3D2.default.ConicArcSensorGeometry = _ConicArcSensorGeometry.ConicArcSensorGeometry;
            _SuperMap3D2.default.ConicArcSensorOutlineGeometry = _ConicArcSensorOutlineGeometry.ConicArcSensorOutlineGeometry;
            _SuperMap3D2.default.ConicArcSensorGraphics = _ConicArcSensorGraphics.ConicArcSensorGraphics;
            _SuperMap3D2.default.ConicArcSensorCollection = _ConicArcSensorCollection.ConicArcSensorCollection;

            var DataSourceDisplay = _SuperMap3D2.default.DataSourceDisplay;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var defineProperties = _SuperMap3D2.default.defineProperties;
            var DeveloperError = _SuperMap3D2.default.DeveloperError;
            var Event = _SuperMap3D2.default.Event;
            var createMaterialPropertyDescriptor = _SuperMap3D2.default.createMaterialPropertyDescriptor;
            var createPropertyDescriptor = _SuperMap3D2.default.createPropertyDescriptor;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var AssociativeArray = _SuperMap3D2.default.AssociativeArray;
            var Cartesian3 = _SuperMap3D2.default.Cartesian3;
            var Color = _SuperMap3D2.default.Color;
            var defined = _SuperMap3D2.default.defined;
            var destroyObject = _SuperMap3D2.default.destroyObject;
            ...
            var Matrix3 = _SuperMap3D2.default.Matrix3;
            var Matrix4 = _SuperMap3D2.default.Matrix4;
            var Quaternion = _SuperMap3D2.default.Quaternion;
            var MaterialProperty = _SuperMap3D2.default.MaterialProperty;
            var Property = _SuperMap3D2.default.Property;
            ...
            RectangularSensorVisualizer.prototype.update = function (time) {
                ...
                for (var i = 0, len = entities.length; i < len; i++) {
                    ...
                    if (defined(gaze)) {
                        ...
                        var rotate = Cartesian3.angleBetween(_SuperMap3D2.default.Cartesian3.UNIT_Z, diffVector);
                        var cross = Cartesian3.cross(_SuperMap3D2.default.Cartesian3.UNIT_Z, diffVector, diffVectorScratch);
                        ...
                        if (!Cartesian3.equals(position, data.position) || !Quaternion.equals(orientation, data.orientation)) {
                            if (defined(orientation)) {
                                ...
                                primitive.modelMatrix = _SuperMap3D2.default.Transforms.eastNorthUpToFixedFrame(position);
                                data.position = Cartesian3.clone(position, data.position);
                            }
                        }
                    }
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var defaultValue = _SuperMap3D2.default.defaultValue;
            var defined = _SuperMap3D2.default.defined;
            var Viewer = _SuperMap3D2.default.Viewer;
            var Transforms = _SuperMap3D2.default.Transforms;
            var DeveloperError = _SuperMap3D2.default.DeveloperError;
            var ColorGeometryInstanceAttribute = _SuperMap3D2.default.ColorGeometryInstanceAttribute;
            var Color = _SuperMap3D2.default.Color;
            var Primitive = _SuperMap3D2.default.Primitive;
            var PerInstanceColorAppearance = _SuperMap3D2.default.PerInstanceColorAppearance;
            var Cartesian3 = _SuperMap3D2.default.Cartesian3;
            var VertexFormat = _SuperMap3D2.default.VertexFormat;
            var Quaternion = _SuperMap3D2.default.Quaternion;
            var Matrix3 = _SuperMap3D2.default.Matrix3;
            ...
            var Property = _SuperMap3D2.default.Property;
            var Event = _SuperMap3D2.default.Event;
            var DistanceDisplayCondition = _SuperMap3D2.default.DistanceDisplayCondition;
            var DistanceDisplayConditionGeometryInstanceAttribute = _SuperMap3D2.default.DistanceDisplayConditionGeometryInstanceAttribute;
            ...
            ConicArcSensorCollection.prototype.update = function () {
                ...
                for (var i = 0, len = conicArcSensorCollection.length; i < len; i++) {
                    ...
                    if (defined(gaze)) {
                        ...
                        radius = 1;
                        modelMatrix = Matrix4.fromRotationTranslation(_SuperMap3D2.default.Matrix3.multiplyByScalar(Matrix3.fromQuaternion(orientation, matrix3Scratch), distance, matrix3Scratch), position, matrix4Scratch);
                    } else {
                    ...
                    if (!defined(geometry)) {
                        ...
                        conic = new _ConicArcSensorGeometry.ConicArcSensorGeometry({
                            vertexFormat: _SuperMap3D2.default.VertexFormat.POSITION_AND_NORMAL,
                            angle: angle,
                            radius: radius,
                    ...
                    var instance = new _SuperMap3D2.default.GeometryInstance({
                        geometry: geometry,
                        modelMatrix: modelMatrix,
                        attributes: {
                            color: _SuperMap3D2.default.ColorGeometryInstanceAttribute.fromColor(color)
                    ...
                    if (outline) {
                        ...
                        if (!defined(outlineGeometry)) {
                            ...
                            conicOutline = new _ConicArcSensorOutlineGeometry.ConicArcSensorOutlineGeometry({
                                vertexFormat: _SuperMap3D2.default.VertexFormat.POSITION_ONLY,
                                angle: angle,
                                radius: radius
                            });
                        ...
                        var instance = new _SuperMap3D2.default.GeometryInstance({
                            ...
                            modelMatrix: modelMatrix,
                            attributes: {
                                color: _SuperMap3D2.default.ColorGeometryInstanceAttribute.fromColor(outlineColor)
                                //distanceDisplayCondition: distanceDisplayConditionAttribute
                            }
                        });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var Entity = _SuperMap3D2.default.Entity;
            var Event = _SuperMap3D2.default.Event;
            var ConstantPositionProperty = _SuperMap3D2.default.ConstantPositionProperty;
            var createPropertyDescriptor = _SuperMap3D2.default.createPropertyDescriptor;
            var DistanceDisplayCondition = _SuperMap3D2.default.DistanceDisplayCondition;
            var DistanceDisplayConditionGeometryInstanceAttribute = _SuperMap3D2.default.DistanceDisplayConditionGeometryInstanceAttribute;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            _SuperMap3D2.default.PolylineAttackLinkMaterialProperty = _PolylineAttackLinkMaterialProperty.PolylineAttackLinkMaterialProperty;
            _SuperMap3D2.default.PolylineArrowLinkMaterialProperty = _PolylineArrowLinkMaterialProperty.PolylineArrowLinkMaterialProperty;
            _SuperMap3D2.default.PolylineGlowLinkMaterialProperty = _PolylineGlowLinkMaterialProperty.PolylineGlowLinkMaterialProperty;
            _SuperMap3D2.default.PolylinePulseLinkMaterialProperty = _PolylinePulseLinkMaterialProperty.PolylinePulseLinkMaterialProperty;
            _SuperMap3D2.default.PolylineTrailLinkMaterialProperty = _PolylineTrailLinkMaterialProperty.PolylineTrailLinkMaterialProperty;
            _SuperMap3D2.default.ElliposidFadeMaterialProperty = _ElliposidFadeMaterialProperty.ElliposidFadeMaterialProperty;
        ...
        (function (module, exports, __webpack_require__) {
            ...
            function getLinkedPointList(startPoint, endPoint, angularityFactor, numOfSingleLine) {
                ...
                var startPosition = _SuperMap3D2.default.Cartographic.fromCartesian(startPoint);
                var endPosition = _SuperMap3D2.default.Cartographic.fromCartesian(endPoint);
                ...
                var startVec = _SuperMap3D2.default.Cartesian3.clone(startPoint);
                var endVec = _SuperMap3D2.default.Cartesian3.clone(endPoint);

                var startLength = _SuperMap3D2.default.Cartesian3.distance(startVec, _SuperMap3D2.default.Cartesian3.ZERO);
                var endLength = _SuperMap3D2.default.Cartesian3.distance(endVec, _SuperMap3D2.default.Cartesian3.ZERO);

                _SuperMap3D2.default.Cartesian3.normalize(startVec, startVec);
                _SuperMap3D2.default.Cartesian3.normalize(endVec, endVec);

                if (_SuperMap3D2.default.Cartesian3.distance(startVec, endVec) == 0) {
                    return result;
                }
                ...
                var omega = _SuperMap3D2.default.Cartesian3.angleBetween(startVec, endVec);
                ...
                for (var i = 1; i < numOfSingleLine - 1; i++) {
                    ...
                    var startScalarVec = _SuperMap3D2.default.Cartesian3.multiplyByScalar(startVec, startScalar, new _SuperMap3D2.default.Cartesian3());
                    var endScalarVec = _SuperMap3D2.default.Cartesian3.multiplyByScalar(endVec, endScalar, new _SuperMap3D2.default.Cartesian3());

                    var centerVec = _SuperMap3D2.default.Cartesian3.add(startScalarVec, endScalarVec, new _SuperMap3D2.default.Cartesian3());

                    var ht = t * Math.PI;
                    var centerLength = startLength * invT + endLength * t + Math.sin(ht) * angularity;
                    centerVec = _SuperMap3D2.default.Cartesian3.multiplyByScalar(centerVec, centerLength, centerVec);
...
//# sourceMappingURL=SuperMap3DGeometry.js.map